...
from .test import router as test_router  # Add this line
from .feature_flags import router as feature_flags_router  # Fixed import name
...
api_router.include_router(test_router, prefix="/test", tags=["test"])  # Add this line
